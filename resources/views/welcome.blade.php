...
<body>
                ...
                <div class="login-form">
                    <div class="sign-in-htm">
                        <div class="group">
                            ...
                            <input id="email" type="text" class="input @error('email') is-invalid @enderror"
    ...
    <div class="overlay" id="overlay">
        <div class="overlay-content">
            ...
            @if(isset($imagen))
                <img width="50%" height="50%" src="{{ asset('uploads/' . $imagen->file_path) }}" alt="Notificación de actualización">
            @else
                <img width="50%" height="50%" src="{{ asset('images/portada.gif') }}" alt="Notificación de actualización">
            @endif
        </div>
    </div>
