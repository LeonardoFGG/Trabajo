<div class="modal fade" id="modalEditEmpleado{{ $empleado->id }}" tabindex="-1" aria-labelledby="editEmpleadoLabel{{ $empleado->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-warning text-white">
                <h5 class="modal-title" id="editEmpleadoLabel{{ $empleado->id }}">
            ...
            <div class="modal-body">
                <form action="{{ route('empleados.update', $empleado->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="border p-4 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="apellido2" name="apellido2"
                                        value="{{ old('apellido2', $empleado->apellido2) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cedula" name="cedula"
                                        value="{{ old('cedula', $empleado->cedula) }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="celular" name="celular"
                                        value="{{ old('celular', $empleado->celular) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="correo_institucional" name="correo_institucional"
                                value="{{ old('correo_institucional', $empleado->correo_institucional) }}" required>
                        </div>
                        </div>
                        ...
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" id="es_supervisor" name="es_supervisor" value="1"
                                {{ old('es_supervisor', $empleado->es_supervisor ? 'checked' : '') }}>
                            <label class="form-check-label" for="es_supervisor">¿Es Supervisor?</label>
                        </div>

                        <div class="form-group" id="supervisorSuperiorWrapper" style="display: {{ old('es_supervisor', $empleado->es_supervisor) ? 'block' : 'none' }};">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jornada_laboral" id="jornada_laboral" class="form-control"
                                        ...
                                        <option value="Medio Tiempo"
                                            {{ old('jornada_laboral', $empleado->jornada_laboral) == 'Medio Tiempo' ? 'selected' : '' }}>
                                            Medio Tiempo</option>
                                        <option value="Tiempo Completo"
                                            {{ old('jornada_laboral', $empleado->jornada_laboral) == 'Tiempo Completo' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="fecha_conclusion"
                                        ...
                                        value="{{ old('fecha_conclusion', $empleado->fecha_conclusion) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group ">
                                    ...
                                    <select name="terminacion_voluntaria" id="terminacion_voluntaria"
                                        ...
                                        <option value="">Selecciona una Opción</option>
                                        <option value="Si"
                                            {{ old('terminacion_voluntaria', $empleado->terminacion_voluntaria) == 'Si' ? 'selected' : '' }}>
                                            Sí</option>
                                        <option value="No"
                                            {{ old('terminacion_voluntaria', $empleado->terminacion_voluntaria) == 'No' ? 'selected' : '' }}>
                                            No</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <!-- Agregás los demás campos que necesités -->
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                @if ($empleado->curriculum)
                                    <small class="form-text text-muted">Archivo actual: <a href="{{ asset($empleado->curriculum) }}" target="_blank">Ver Currículum</a></small>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @if ($empleado->contrato)
                                    <small class="form-text text-muted">Archivo actual: <a href="{{ asset($empleado->contrato) }}" target="_blank">Ver Contrato</a></small>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                @if ($empleado->contrato_confidencialidad)
                                    <small class="form-text text-muted">Archivo actual: <a href="{{ asset($empleado->contrato_confidencialidad) }}" target="_blank">Ver Contrato de Confidencialidad</a></small>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @if ($empleado->contrato_consentimiento)
                                    <small class="form-text text-muted">Archivo actual: <a href="{{ asset($empleado->contrato_consentimiento) }}" target="_blank">Ver Contrato de Consentimiento de Datos</a></small>
                                @endif
                            </div>
                        </div>
                    </fieldset>
                                ...
                                @foreach ($rubros as $rubro)
                                    <div class="form-check m-2">
                                        <input class="form-check-input" type="checkbox" name="rubros[]"
                                            ...
                                            {{ in_array($rubro->id, $empleado->rubros->pluck('id')->toArray()) ? 'checked' : '' }}>
                                        ...
                                        <div class="mt-2">
                                            <input type="number" class="form-control"
                                                ...
                                                value="{{ $empleado->rubros->contains('id', $rubro->id) ? $empleado->rubros->where('id', $rubro->id)->first()->pivot->monto : 0 }}"
