    ...
    <div id="app">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                @if ((Auth::check() && Auth::user()->isAdmin()) || Auth::user()->id == 3)
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('analisis.indexGestion') ? 'active' : '' }}"
                            href="{{ route('analisis.indexGestion') }}" title="Gestión Financiero">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('analisis.indexMatriz') ? 'active' : '' }}"
                            href="{{ route('analisis.indexMatriz') }}" title="Matriz de Cumplimientos">
                            <i class="bi bi-table"></i> <span>Matriz de Cumplimientos</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('analisis.indexSatisfaccion') ? 'active' : '' }}"
                            href="{{ route('analisis.indexSatisfaccion') }}" title="Satisfaccion del Cliente">
                            <i class="fas fa-user-shield"></i> <span>Satisfaccion del Cliente</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('analisis.indexExterno') ? 'active' : '' }}"
                            href="{{ route('analisis.indexExterno') }}" title="Analisis Externo">
