    ...
    <div id="app">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                @if ((Auth::check() && Auth::user()->isAdmin()) || (Auth::check() && Auth::user()->isGerenteGeneral()))
                    
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('matriz_cumplimientos.*') ? 'active' : '' }}"
                            href="{{ route('matriz_cumplimientos.index') }}" title="Matriz de Cumplimientos">
                            <i class="fas fa-th-list"></i> <span>Matriz de Cumplimientos</span>
                        </a>
                    </li>
