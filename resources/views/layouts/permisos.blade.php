    ...
    <div id="app">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                @if ((Auth::check() && Auth::user()->isAdmin()) || Auth::user()->empleado->es_supervisor|| (Auth::check() && Auth::user()->isGerenteGeneral()) || (Auth::check() &&  Auth::user()->isAsistenteGerencial()) )
                    <ul class="nav nav-list">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('permisos.indexHoras') ? 'active' : '' }}"
                                href="{{ route('permisos.indexHoras') }}" title="Permisos de Horas">
