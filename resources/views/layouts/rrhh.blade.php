        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                @if (Auth::check() && Auth::user()->isAdmin())
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('empleados.indexEmpleados') ? 'active' : '' }}"
                            href="{{ route('empleados.indexEmpleados') }}" title="Empleados">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('departamentos.index') ? 'active' : '' }}"
                            href="{{ route('departamentos.index') }}" title="Departamentos">
                            <i class="fas fa-building"></i> <span>Departamentos</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('cargos.index') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('supervisores.index') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('rubros.index') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('parametros.index') ? 'active' : '' }}"
                            href="{{ route('parametros.index') }}" title="Parametros">
