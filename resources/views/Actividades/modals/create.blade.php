    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="crearActividadModalLabel"><i class="fas fa-tasks"></i> Crear Nueva Actividad
                </h5>
            ...
            <div class="modal-body">
                {{-- AQUÍ VA TODO EL FORMULARIO COMPLETO --}}
                @if ($errors->any())
                ...
                <form action="{{ route('actividades.store') }}" method="POST">
                    @csrf
                    {{-- ...TODO el contenido del formulario que ya tienes... --}}
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-md-6">
                            <input type="number" name="tiempo_estimado" class="form-control"
                                placeholder="Ingrese el tiempo estimado en min" value="{{ old('tiempo_estimado') }}"
                                min="0" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-md-6">
                            <select name="error" class="form-select" required>
                                ...
                                <option value="ESTRUCTURA" {{ old('error') == 'ESTRUCTURA' ? 'selected' : '' }}>
                                    Estructura
                                </option>
                                ...
                                <option value="SOFTWARE" {{ old('error') == 'SOFTWARE' ? 'selected' : '' }}>
                                    Software</option>
                                <option value="MEJORA ERROR" {{ old('error') == 'MEJORA ERROR' ? 'selected' : '' }}>
                                    Mejora
                                    Error
                                </option>
                                <option value="INSTALACION" {{ old('error') == 'INSTALACION' ? 'selected' : '' }}>
                                    Instalacion
                                </option>
                                <option value="DESARROLLO-ACTUALIZACION"
                                    {{ old('error') == 'DESARROLLO-ACTUALIZACION' ? 'selected' : '' }}>
                    ...
                    <div class="form-group row mb-2">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="{{ route('actividades.indexActividades') }}" class="btn btn-primary btn-lg m-2">
