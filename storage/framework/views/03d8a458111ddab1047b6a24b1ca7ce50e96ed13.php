...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid mt-7">
        ...
        <?php if(Auth::user()->isAdmin() ||
            ...
            <form action="<?php echo e(route('actividades.indexActividades')); ?>" method="GET"
                ...
                <div class="d-flex flex-column flex-md-row gap-3 align-items-center">
                    ...
                    <script>
                        flatpickr("#daterange", {
                            ...
                            dateFormat: "Y-m-d",
                            defaultDate: [
                                "<?php echo e(request('start_date', now()->format('Y-m-d'))); ?>",
                                "<?php echo e(request('end_date', now()->format('Y-m-d'))); ?>"
                            ],
                            locale: {
                                firstDayOfWeek: 1,
                                weekdays: {
                    ...
                    <div class="d-flex gap-3">
                        <div class="estado-card pastel-morado d-flex flex-column align-items-center justify-content-center p-1 rounded shadow-sm"
                            ...
                            <p class="estado-titulo mb-0" style="font-size: 0.9rem;"><?php echo e($enCursoCount); ?></p>
                        </div>
                        <div class="estado-card pastel-naranja d-flex flex-column align-items-center justify-content-center p-1 rounded shadow-sm"
                            ...
                            <p class="estado-titulo mb-0" style="font-size: 0.9rem;"><?php echo e($pendienteCount); ?></p>
                        </div>
                        <div class="estado-card pastel-verde d-flex flex-column align-items-center justify-content-center p-1 rounded shadow-sm"
                            ...
                            <p class="estado-titulo mb-0" style="font-size: 0.9rem;"><?php echo e($finalizadoCount); ?></p>
                        </div>
                    </div>
        ...
        <?php else: ?>
            <form method="GET" action="<?php echo e(route('actividades.indexActividades')); ?>"
        ...
        <div class="d-flex justify-content-between">
            <a href="<?php echo e(route('actividades.create')); ?>" class="btn btn-primary btn-lg ms-3"
            ...
            <?php if(Auth::user()->isAdmin() ||
                    ...
                    Auth::user()->isSupervisor()): ?>
                <div>
                    <a href="<?php echo e(route('actividades.exportar.servicio-hora', 'excel')); ?>" class="btn btn-success">
                        <i class="fas fa-file-excel"></i> Exportar Excel (Servicio x Hora)
                    </a>
                    <a href="<?php echo e(route('actividades.exportar.servicio-hora', 'pdf')); ?>" class="btn btn-danger">
        ...
        <div class="table-responsive">
                ...
                <tbody>
                    <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($actividad->cliente ? $actividad->cliente->nombre : 'No asignado'); ?></td>
                            <td><?php echo e($actividad->producto->nombre ?? 'N/A'); ?></td>
                            <td><?php echo e($actividad->empleado ? $actividad->empleado->nombre1 . ' ' . $actividad->empleado->apellido1 : 'No asignado'); ?>
                            ...
                            <td class="descripcion-limite">
                                ...
                                <?php if(Auth::user()->isAdmin() ||
                                    ...
                                    <button type="button" class="btn btn-outline-info btn-sm mt-1"
                                        data-bs-toggle="modal" data-bs-target="#modalVerDescripcion<?php echo e($actividad->id); ?>">
                                        Ver más
                                    </button>
                                <?php endif; ?>
                            </td>
                            ...
                            <div class="modal fade" id="modalVerDescripcion<?php echo e($actividad->id); ?>" tabindex="-1"
                                aria-labelledby="modalVerDescripcionLabel<?php echo e($actividad->id); ?>" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <form action="<?php echo e(route('actividades.update', $actividad->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>

                                            <div class="modal-header">
                                                <h5 class="modal-title"
                                                    id="modalVerDescripcionLabel<?php echo e($actividad->id); ?>">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="descripcion" class="form-control" rows="6" required><?php echo e($actividad->descripcion); ?></textarea>
                                                </div>
                                            </div>
                            ...
                            <td>
                                <span><?php echo e($actividad->error ?? 'N/A'); ?></span><br>
                                <?php if(Auth::user()->isAdmin() ||
                                        Auth::user()->isGerenteGeneral() ||
                                        Auth::user()->isAsistenteGerencial() ||
                                        Auth::user()->isSupervisor()): ?>
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary mt-1"
                                        data-bs-toggle="modal" data-bs-target="#modalEditarError<?php echo e($actividad->id); ?>">
                                        Editar
                                    </button>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <?php if(!empty($actividad->codigo_osticket)): ?>
                                    <a href="<?php echo e($actividad->codigo_osticket); ?>" target="_blank"
                            ...
                            <td><?php echo e($actividad->fecha_inicio->format('d-m-Y h:i:s A')); ?></td>

                            <td>
                                <!-- Muestra el estado actual con el diseño de badge -->
                                <span
                                    class="badge <?php echo e($actividad->estado == 'EN CURSO' ? 'bg-pastel-morado' : ($actividad->estado == 'FINALIZADO' ? 'bg-pastel-verde' : 'bg-pastel-naranja')); ?>">
                                    <?php echo e($actividad->estado); ?>
                            ...
                            <td>
                                <div class="progress" style="height: 25px;">
                                    <div class="progress-bar" role="progressbar"
                                        style="width: <?php echo e($actividad->avance); ?>%;"
                                        aria-valuenow="<?php echo e($actividad->avance); ?>" aria-valuemin="0" aria-valuemax="100">
                                        <?php echo e($actividad->avance); ?>%
                                    </div>
                                </div>

                                <?php if(Auth::user()->isEmpleado()): ?>
                                    <!-- Mostrar botón de finalizar si la actividad está en curso o pendiente -->
                                    <?php if($actividad->estado === 'EN CURSO' || $actividad->estado === 'PENDIENTE'): ?>
                                        <form action="<?php echo e(route('actividades.updateEstado', $actividad->id)); ?>"
                                    ...
                                    <?php if($actividad->estado === 'EN CURSO'): ?>
                                        <form action="<?php echo e(route('actividades.updateEstado', $actividad->id)); ?>"
                            ...
                            <td>
                                <?php if($actividad->avance < 100): ?>
                                    <!-- Botón para abrir el modal de edición -->
                                    <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modalObservaciones<?php echo e($actividad->id); ?>">
                                        Ingresar Observaciones
                                    </button>

                                    <!-- Modal para ingresar observaciones -->
                                    <div class="modal fade" id="modalObservaciones<?php echo e($actividad->id); ?>" tabindex="-1"
                                        aria-labelledby="modalObservacionesLabel<?php echo e($actividad->id); ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="modalObservacionesLabel<?php echo e($actividad->id); ?>">
                                                ...
                                                <form
                                                    action="<?php echo e(route('actividades.updateObservaciones', $actividad->id)); ?>"
                                                    method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>
                                                    <div class="modal-body">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="observaciones" class="form-control" rows="6" placeholder="Ingrese observaciones"><?php echo e(old('observaciones', $actividad->observaciones)); ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                ...
                                <?php else: ?>
                                    ...
                                    <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#modalVerObservaciones<?php echo e($actividad->id); ?>">
                                        Ver Observaciones
                                    </button>

                                    <!-- Modal para ver observaciones -->
                                    <div class="modal fade" id="modalVerObservaciones<?php echo e($actividad->id); ?>"
                                        tabindex="-1" aria-labelledby="modalVerObservacionesLabel<?php echo e($actividad->id); ?>"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="modalVerObservacionesLabel<?php echo e($actividad->id); ?>">
                                                        Observaciones
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="p-3 bg-light border rounded">
                                                        <p class="mb-0"><?php echo e($actividad->observaciones); ?></p>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                            ...
                            <td><?php echo e($actividad->tiempo_estimado); ?></td>
                            <td><?php echo e($actividad->estado === 'FINALIZADO' ? ($actividad->tiempo_real_horas ?? 0) . ' h y ' . ($actividad->tiempo_real_minutos ?? 0) . ' min' : 'N/A'); ?>
                                ...
                                <?php if(Auth::user()->isAdmin() ||
                                    ...
                                    <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#editarTiempoModal<?php echo e($actividad->id); ?>">
                                        Editar Tiempo
                                    </button>

                                    <!-- Modal para ver observaciones -->
                                    <div class="modal fade" id="editarTiempoModal<?php echo e($actividad->id); ?>" tabindex="-1"
                                        aria-labelledby="editarTiempoModalLabel<?php echo e($actividad->id); ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="editarTiempoModalLabel<?php echo e($actividad->id); ?>">
                                                        Editar Tiempo Modal
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="<?php echo e(route('actividades.updateTiempoReal', $actividad->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('PUT'); ?>
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="tiempo_real_horas"
                                                                class="form-control"
                                                                value="<?php echo e(old('tiempo_real_horas', $actividad->tiempo_real_horas)); ?>">
                                                        </div>
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" name="tiempo_real_minutos"
                                                                class="form-control"
                                                                value="<?php echo e(old('tiempo_real_minutos', $actividad->tiempo_real_minutos)); ?>">
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal">Cancelar</button>
                            ...
                            <td><?php echo e($actividad->fecha_fin ? $actividad->fecha_fin->format('d-m-Y') : ''); ?></td>

                            <td><span
                                    class="badge <?php echo e($actividad->prioridad == 'ALTA' ? 'bg-danger text-light' : ($actividad->prioridad == 'MEDIA' ? 'bg-warning text-dark' : 'bg-success text-light')); ?>"><?php echo e($actividad->prioridad); ?></span>
                            </td>
                            ...
                            <td class="text-center">
                                <?php if(Auth::user()->isAdmin()): ?>
                                    <a href="<?php echo e(route('actividades.show', $actividad->id)); ?>" class="btn btn-info btn-sm"
                                        title="Ver">
                                    ...
                                    <form action="<?php echo e(route('actividades.destroy', $actividad->id)); ?>" method="POST"
                                ...
                                <?php else: ?>
                                    <a href="javascript:void(0)" class="btn btn-info btn-sm show-actividad"
                                        data-id="<?php echo e($actividad->id); ?>" title="Ver">
                                        <i class="fas fa-eye fa-md"></i>
                                    </a>
                                <?php endif; ?>
                            </td>
            ...
            <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="modal fade" id="modalEditarError<?php echo e($actividad->id); ?>" tabindex="-1"
                    aria-labelledby="modalEditarErrorLabel<?php echo e($actividad->id); ?>" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="<?php echo e(route('actividades.update', $actividad->id)); ?>" method="POST">
                                ...
                                <?php echo method_field('PUT'); ?>
                                <div class="modal-header">
                                    <h5 class="modal-title" id="modalEditarErrorLabel<?php echo e($actividad->id); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="error" class="form-select" required>
                                            ...
                                            <option value="ESTRUCTURA"
                                                <?php echo e($actividad->error == 'ESTRUCTURA' ? 'selected' : ''); ?>>Estructura
                                            </option>
                                            <option value="CLIENTE"
                                                <?php echo e($actividad->error == 'CLIENTE' ? 'selected' : ''); ?>>Cliente</option>
                                            <option value="SOFTWARE"
                                                <?php echo e($actividad->error == 'SOFTWARE' ? 'selected' : ''); ?>>Software</option>
                                            <option value="MEJORA ERROR"
                                                <?php echo e($actividad->error == 'MEJORA ERROR' ? 'selected' : ''); ?>>Mejora Error
                                            </option>
                                            <option value="DESARROLLO"
                                                <?php echo e($actividad->error == 'DESARROLLO' ? 'selected' : ''); ?>>Desarrollo
                                            </option>
                                            <option value="OTRO" <?php echo e($actividad->error == 'OTRO' ? 'selected' : ''); ?>>
                                                Otros</option>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/Actividades/indexActividades.blade.php ENDPATH**/ ?>