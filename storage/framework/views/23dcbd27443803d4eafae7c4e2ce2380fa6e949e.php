...
<?php $__env->startSection('content'); ?>
    <div class="container mt-7">
        ...
        <div class="text-left">
            <a href="<?php echo e(route('empleados.create')); ?>" class="btn btn-primary mb-3" style="margin-left: 1rem;">Nuevo
                Empleado</a>
        </div>
                ...
                <tbody>
                    <?php $__currentLoopData = $empleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($empleado->nombre1 . ' ' . $empleado->nombre2); ?></td>
                            <td><?php echo e($empleado->apellido1 . ' ' . $empleado->apellido2); ?></td>
                            <td><?php echo e($empleado->cedula); ?></td>
                            <td><?php echo e($empleado->fecha_nacimiento); ?></td>
                            <td><?php echo e($empleado->celular); ?></td>
                            <td><?php echo e($empleado->correo_institucional); ?></td>
                            <td><?php echo e(optional($empleado->departamento)->nombre ?? 'N/A'); ?></td>
                            <td><?php echo e(optional($empleado->cargo)->nombre_cargo ?? 'N/A'); ?></td>
                            <td>
                                <?php if($empleado->es_supervisor && !$empleado->supervisor_id): ?>
                                    Supervisor Superior
                                <?php elseif($empleado->es_supervisor): ?>
                                    Supervisor
                                <?php elseif($empleado->supervisor_id): ?>
                                    <?php echo e($empleado->supervisor->nombre_supervisor ?? 'N/A'); ?>

                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td><?php echo e($empleado->fecha_contratacion ? \Carbon\Carbon::parse($empleado->fecha_contratacion)->format('d/m/Y') : 'N/A'); ?>

                            </td>
                            <td><?php echo e($empleado->jornada_laboral); ?></td>
                            <td>
                                <?php if($empleado->curriculum): ?>
                                    <a href="<?php echo e(asset($empleado->curriculum)); ?>" target="_blank">Ver Currículum</a>
                                <?php else: ?>
                                    <span class="text-danger">No tiene curriculum</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($empleado->contrato): ?>
                                    <a href="<?php echo e(asset($empleado->contrato)); ?>" target="_blank">Ver Contrato</a>
                                <?php else: ?>
                                    <span class="text-danger">No tiene contrato</span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($empleado->contrato_confidencialidad): ?>
                                    <a href="<?php echo e(asset($empleado->contrato_confidencialidad)); ?>" target="_blank">Ver
                            ...
                            <td>
                                <?php if($empleado->contrato_consentimiento): ?>
                                    <a href="<?php echo e(asset($empleado->contrato_consentimiento)); ?>" target="_blank">Ver Contrato
                                        de Consentimiento</a>
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('empleados.show', $empleado->id)); ?>" class="btn btn-info btn-sm"
                                    title="Ver"><i class="fas fa-eye fa-md"></i></a>
                                <a href="<?php echo e(route('empleados.edit', $empleado->id)); ?>" class="btn btn-warning btn-sm"
...
<?php echo $__env->make('layouts.rrhh', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/Empleados/indexEmpleados.blade.php ENDPATH**/ ?>