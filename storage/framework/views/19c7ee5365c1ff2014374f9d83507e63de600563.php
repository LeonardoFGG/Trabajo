            ...
            <ul class="nav nav-list">
                ...
                <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
                    <ul class="nav nav-list">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('paquetes.index') ? 'active' : ''); ?>"
                                href="<?php echo e(route('paquetes.index')); ?>" title="Paquetes">
...
<?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/layouts/productos.blade.php ENDPATH**/ ?>