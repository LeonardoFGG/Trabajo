...
<?php $__env->startSection('content'); ?>
    <style>
        .home-background {
            background-image: url('<?php echo e(asset('images/nova-tics-fondo.jpg')); ?>');
            /* Ruta de la imagen */
    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            ...
            ['route' => 'imagen.index', 'img' => 'ventas.png', 'title' => 'Anuncio'],
                                            ...
                                            <div class="card-body d-flex flex-column align-items-center">
                                                <a href="<?php echo e(route($item['route'])); ?>">
                                                    <img src="<?php echo e(asset('images/' . $item['img'])); ?>"
                                                        alt="<?php echo e($item['title']); ?>" class="img-fluid mb-2"
                                                        style="width: 60px; height: 60px;">
                                                    <h5 class="card-title"> <span style="color: white;">
                                                            <?php echo e($item['title']); ?></h5> </span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php elseif(Auth::user()->isEmpleado()): ?>
                            ...
                            <?php endif; ?>
                            <?php if(Auth::user()->isEmpleado() && Auth::user()->empleado->es_supervisor): ?>
                                <div class="col-md-5 mb-5 center">
                                    <div class="card h-100 shadow center">
                                        <div class="card-body d-flex flex-column align-items-center">
                                            <a href="<?php echo e(route('matriz_cumplimientos.index')); ?>">
                            ...
                            <?php if(Auth::user()->id == 8): ?>
                                <div class="col-md-5 mb-5 center">
                                    <div class="card h-100 shadow center">
                                        <div class="card-body d-flex flex-column align-items-center">
                                            <a href="<?php echo e(route('imagen.index')); ?>">
                            ...
                            <?php if(Auth::user()->isGerenteGeneral() || Auth::user()->isSupervisor()): ?> 
                                <div class="col-md-5 mb-5 center">
                                    <div class="card h-100 shadow center">
                                        <div class="card-body d-flex flex-column align-items-center">
                                            <a href="<?php echo e(route('analisis.indexAnalisis')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/home.blade.php ENDPATH**/ ?>