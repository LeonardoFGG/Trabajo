        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <?php if(Auth::check() && Auth::user()->isAdmin()): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('empleados.indexEmpleados') ? 'active' : ''); ?>"
                            href="<?php echo e(route('empleados.indexEmpleados')); ?>" title="Empleados">
                            <i class="fas fa-users"></i> <span>Empleados</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('departamentos.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('departamentos.index')); ?>" title="Departamentos">
                            <i class="fas fa-building"></i> <span>Departamentos</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('cargos.index') ? 'active' : ''); ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('supervisores.index') ? 'active' : ''); ?>"
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('rubros.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('rubros.index')); ?>" title="Rubros">
                            <i class="fas fa-list-ul"></i> <span>Rubros</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('roles_pago.index') ? 'active' : ''); ?>"
                            ...
                            <i class="fas fa-money-check-alt"></i> <span>Roles de Pago</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('vacaciones.index') ? 'active' : ''); ?>"
                            ...
                            <i class="fas fa-calendar"></i> <span>Vacaciones</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('permisos.index') ? 'active' : ''); ?>"
                            ...
                            <i class="fas fa-calendar"></i> <span>Permisos</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('parametros.index') ? 'active' : ''); ?>"
                            href="<?php echo e(route('parametros.index')); ?>" title="Parametros">
...
<?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/layouts/rrhh.blade.php ENDPATH**/ ?>