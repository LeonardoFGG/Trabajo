                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <p><strong>Modalidad:</strong> <?php echo e($producto->modalidad ?? 'N/A'); ?></p>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <form action="<?php echo e(route('productos.update', $producto->id)); ?>" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="modalidad">
                                                    ...
                                                    <option value="remoto"
                                                        <?php echo e($producto->modalidad == 'remoto' ? 'selected' : ''); ?>>
                                                        Remoto</option>
                                                    <option value="presencial"
                                                        <?php echo e($producto->modalidad == 'presencial' ? 'selected' : ''); ?>>
                                                        Presencial</option>
                                                </select>
                                            </div>
