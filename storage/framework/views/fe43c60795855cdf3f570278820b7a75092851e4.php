            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <form method="GET" action="<?php echo e(route('daily.index')); ?>" id="filter-form">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <a href="<?php echo e(route('daily.create')); ?>" class="btn btn-primary">
                                        ...
                                        <select name="departamento_id" id="departamento_id" class="form-select"
                                            ...
                                            <?php $__currentLoopData = $departamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $departamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($departamento->id); ?>"
                                                    <?php echo e(request('departamento_id') == $departamento->id ? 'selected' : ''); ?>>
                                ...
                                <div class="d-flex justify-content-center align-items-center mt-3 mt-md-0">
                                    <a href="<?php echo e(route('daily.index')); ?>" class="btn btn-secondary">
                ...
                <div class="table-responsive mt-4">
                    <table id="daily-scrum-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $dailies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $daily): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(\Carbon\Carbon::parse($daily->fecha)->format('d-m-Y')); ?></td>
                                    <!-- Fecha formateada -->
                                    <td><?php echo e($daily->empleado->nombre1); ?> <?php echo e($daily->empleado->apellido1); ?></td>
                                    <td><?php echo e($daily->ayer); ?></td>
                                    <td><?php echo e($daily->hoy); ?></td>
                                    <td><?php echo e($daily->dificultades); ?></td>
                                    <td>
                                        <?php if(Auth::user()->isAdmin()): ?>
                                            <a href="<?php echo e(route('daily.edit', $daily)); ?>" class="btn btn-warning btn-sm">
                                                <i class="fas fa-edit"></i> 
                                            </a>

                                            <a href="<?php echo e(route('daily.show', $daily)); ?>" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye
                                            "></i>
                                            </a>

                                            <form action="<?php echo e(route('daily.destroy', $daily->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/Daily/index.blade.php ENDPATH**/ ?>