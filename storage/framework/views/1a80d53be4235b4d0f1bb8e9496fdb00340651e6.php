    ...
    <div id="app">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <!-- Links for Admin -->
                <?php if(Auth::check() && Auth::user()->isAdmin() || Auth::user()->isGerenteGeneral()|| Auth::user()->isAsistenteGerencial()): ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->routeIs('vacaciones.indexSaldo') ? 'active' : ''); ?>"
                            href="<?php echo e(route('vacaciones.indexSaldo')); ?>" title="Vacaciones">
...
</html><?php /**PATH C:\Users\WebCoop_Jhoa\Documents\repositorio\Mio\Trabajo\resources\views/layouts/vacaciones.blade.php ENDPATH**/ ?>